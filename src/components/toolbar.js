          ...
          <div>
            ...
            <Tab.Content animation>
              <Tab.Pane eventKey="help-introductory">
                <h4 className="modal-subtitle">Introductory Tutorial</h4>
                <br />
              ...
              <Tab.Pane eventKey="help-projects">
                <h4 className="modal-subtitle">Filtered Map by Project</h4>
              ...
              <Tab.Pane eventKey="help-requirements">
                ...
                <p>WebGL must be enabled in browser: <a href="https://s3-eu-west-1.amazonaws.com/jewish-cultures-mapped/media/Enable+WebGL+in+Browsers-20170822173515.pdf" target="_blank">Instructions for enabling WebGL for all browsers</a></p>
                <br />
